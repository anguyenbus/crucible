...
from crucible.stubs.service.config import StubConfig
...
def create_app(config: StubConfig) -> FastAPI:
    ...
    from crucible.stubs.service.config import DEFAULT_PROJECT_NAME
    from crucible.stubs.service.tracing import setup_phoenix_tracer
    ...
    from crucible.stubs.service.endpoints import router
