...
Flow B (``crucible.service.phoenix.experiments`` + ``...evaluators``) is the path
...
from crucible.service.phoenix import evaluators as evaluators_mod  # noqa: E402
from crucible.service.phoenix import experiments as experiments_mod  # noqa: E402
from crucible.service.phoenix.experiments import (  # noqa: E402
    _build_judge,
    create_rag_task,
...
def test_build_judge_calls_get_deepeval_llm_with_bedrock(monkeypatch, stub_judge):
    ...
    monkeypatch.setattr(
        "crucible.service.deepeval.bedrock_provider.get_deepeval_llm",
