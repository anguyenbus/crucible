...
- crucible.stubs.rag.generator._resolve_generator_provider_and_model / _resolve_region
- crucible.metrics.deepeval_config._resolve_judge_provider_and_model / _resolve_bedrock_region
...
def test_au_profile_model_not_misclassified_as_openai():
    ...
    from crucible.stubs.rag.generator import _is_bedrock_model
