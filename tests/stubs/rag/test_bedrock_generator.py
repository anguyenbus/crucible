...
Covers the boto3-client layer of crucible.stubs.rag.generator._generate_bedrock:
...
from crucible.stubs.rag import generator as gen_mod
from crucible.stubs.rag.generator import LLMGenerator
