...
Covers the boto3-client layer of crucible.local.stubs.rag.generator._generate_bedrock:
...
from crucible.local.stubs.rag import generator as gen_mod
from crucible.local.stubs.rag.generator import LLMGenerator
