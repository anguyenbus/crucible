...
to external servers. ``crucible.kernel.rag_metrics`` is one of the two allowlisted
...
def test_kernel_rag_metrics_sets_optout_before_deepeval() -> None:
    ...
    code = (
        ...
        "import crucible.kernel.rag_metrics  # noqa: F401\n"
    ...
    assert deepeval_loaded == "False", (
        "deepeval was imported by crucible.kernel.rag_metrics before the opt-out could "
