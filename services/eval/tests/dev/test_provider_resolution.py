...
- dev.stubs.rag.generator._resolve_generator_provider_and_model / _resolve_region
- app.deepeval.bedrock_provider._resolve_judge_provider_and_model
...
def test_au_profile_model_recognised_non_bedrock_rejected():
    ...
    from dev.stubs.rag.generator import _is_bedrock_model
